...
if __name__ == '__main__':
    ...
    messagebox.showinfo('good',"If you find yourself having to cross a piranha-infested river, here's how to do it...")
    # Get the player to enter an adjective
    adjective=simpledialog.askstring(title='Greeter', prompt='enter an adjective')
    # Get the player to enter a type of liquid
    p=simpledialog.askstring(title='Greeter', prompt='enter a type of liquid')
    # Get the player to enter a body part
    c=simpledialog.askstring(title='Greeter', prompt='enter a body part')
    # Get the player to enter a verb
    e=simpledialog.askstring(title='Greeter', prompt='enter a verb')
    # Get the player to enter a place
    r=simpledialog.askstring(title='Greeter', prompt='enter a place')
    ...
    story = (
        ...
        "night. Piranhas are attracted to fresh " + p + " and will most\n"
        "likely take a bite out of your " + c + " if you " + e + ". Whatever\n"
        "you do, if you have an open wound, try to find another way to get "
        "back to the " + r + ". Good luck!"
    )
    ...
    messagebox.showinfo('bunny,', story)
